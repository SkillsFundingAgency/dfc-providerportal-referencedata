...
namespace Dfc.ProviderPortal.ReferenceData.Functions
{
    ...
    {
        public const string ApiTitle = "Apprenticeship Reference Data API";
        ...
        public HttpResponseMessage Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "referencedata/" + ApiDefinitionName)] HttpRequest req)
        {
